...
import '../styles/One.module.css';

function one() {
    return (
        <div className="one-background" style={{backgroundColor:'#c4c4c4'}}>
            <div className='one-colored-background' style={{backgroundColor:'#FD6F73', borderRadius:'20px'}}>
               <div className='row1-one' style={{textAlign:'center'}}>
                   <h2 className='one-page-title' style={{color:'white'}}>O.N.E. PROGRAM </h2>
               </div>
               
                <div className='one-row' style={{display:'flex'}}>
                    <div className="one-logo" style={{height:'100%', margin:'20px'}}>
                        <Image className='ONElogo'src='/images/One-Program.png'  height='250px' width='500px' ></Image>
                    </div>
                    <div className='one-content-background' style={{backgroundColor:'white', borderRadius:'20px'}}>
